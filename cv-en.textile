...
|_. Born |04.07.1978|
|_. Current | Ruby on Rails Developer|
...
table(key-value).
|_. 2012 - current|Ruby Developer – mindmatters GmbH|
...
table(key-value).
|_. 2014 |Released first version of terminal based password manager https://github.com/flooose/password-utility|
